...
export const ELECTRON_EVENTS = {
  ...
  // Scheduler
  SETTING_SCHEDULER_MONTHLY: "SETTING_SCHEDULER_MONTHLY",
  SETTING_SCHEDULER_REMOVE: "SETTING_SCHEDULER_REMOVE",
  SETTING_SCHEDULER_TEST: "SETTING_SCHEDULER_TEST",
  SETTING_SCHEDULER_NEXT_RUN: "SETTING_SCHEDULER_NEXT_RUN",
};
